...
SELECT * FROM dbo.CuentaTarjetaMaestra;

ALTER TABLE dbo.CuentaTarjetaMaestra
ALTER COLUMN InteresAcumuladoCorriente INT NULL;

ALTER TABLE dbo.CuentaTarjetaMaestra
ALTER COLUMN InteresAcumuladoMoratorio INT NULL;

SELECT * FROM dbo.CuentaTarjetaCredito
ALTER TABLE dbo.CuentaTarjetaCredito ADD FechaCreacion DATE NOT NULL;
...
ALTER TABLE dbo.TarjetaFisica ADD IdTCM INT NULL;

ALTER TABLE dbo.TarjetaFisica
ALTER COLUMN IdMotivoInvalidacion INT NULL;
...
ALTER TABLE dbo.TarjetaFisica ADD EstadoTF BIT NOT NULL;

ALTER TABLE dbo.TarjetaFisica
ADD CONSTRAINT fk_TarjetaFisica_CuentaTarjetaAdicional
FOREIGN KEY (IdTCA)
REFERENCES dbo.CuentaTarjetaAdicional (Id);
